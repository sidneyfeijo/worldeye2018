...
//alert($scope.send.client_id);
//alert($scope.send.beneficiary_id);
//alert($scope.send.bankaccount_id);
//alert($scope.send.accounttype);
//alert($scope.send.reference);
//alert($scope.send.emailben);
//alert($scope.send.currency);
//alert($scope.send.rate);
//alert($scope.send.fee);
//alert($scope.send.valorDestino);
//alert($stateParams.curpairdest);
//alert($stateParams.ctrycode);
